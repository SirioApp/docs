...
<Steps>
  ...
  <Step title="Coordinate launch and approval">
    The agent should not be presented as fully live until project approval is complete.
  </Step>
</Steps>
...
- or treating KYC/KYB and legal accountability as secondary details.
