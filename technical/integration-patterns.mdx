...
The safest integrations are the ones that reproduce the same ordering discipline the platform expects from human operators: select the environment, identify the project, read the state, then decide whether action is appropriate.
