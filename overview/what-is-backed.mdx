...
For launchers behind the agent, that also means accountability. The platform does not treat the agent as a legal void. The party launching the agent remains responsible for how it is presented and introduced to the market.
